...
export const metadata: Metadata = {
  ...
  description:
    "Reptiscale terms of service. The rules and guidelines for using Reptiscale.",
};
  ...
  return (
    <>
      ...
      <section style={{ padding: "64px 24px 96px", background: "#F5F5F0" }}>
        ...
        >
          <p style={pStyle}>
            Welcome to Reptiscale. By using our website at Reptiscale.ai and our services, you agree
            to these Terms of Service. Please read them carefully.
          </p>

          <h2 style={headingStyle}>1. What Reptiscale Is</h2>
          <p style={pStyle}>
            Reptiscale provides software tools and services designed to help reptile breeders
          ...
          <p style={pStyle}>
            When you sign up for Reptiscale, you are responsible for keeping your account
          ...
          <p style={pStyle}>
            Reptiscale subscriptions are billed monthly after your initial setup period. Prices
            are listed on our{" "}
          ...
          <p style={pStyle}>
            You can cancel your Reptiscale subscription at any time. There are no long-term
          ...
          <p style={pStyle}>
            You own your data. The contacts, leads, messages, and content you put into Reptiscale
          ...
          <ul style={{ ...pStyle, paddingLeft: "24px" }}>
            <li style={{ marginBottom: "8px" }}>Use Reptiscale for anything illegal or harmful</li>
            ...
            <li style={{ marginBottom: "8px" }}>Reverse-engineer, copy, or resell any part of Reptiscale</li>
          ...
          <p style={pStyle}>
            Reptiscale uses AI to help draft social media posts, email replies, and shipping
          ...
          <p style={pStyle}>
            Reptiscale&apos;s Smart Shipping feature provides weather-based recommendations for
          ...
          <p style={pStyle}>
            Reptiscale is provided &quot;as is.&quot; We do our best to keep things running
          ...
          <p style={pStyle}>
            ...
            Reptiscale after changes take effect means you accept the new terms.
          </p>
